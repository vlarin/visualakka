 ...
 * @author Oleg Bantysh
 */
public class EntryButton extends JButton implements Transferable, DragSourceListener, DragGestureListener {
     ...
     * @param text
     */
    public EntryButton(String text) {
            super(text);
